...
set output "vol_src_small.png"
set title "50 Plus Petites Usines - Volume Capté"
set ylabel "Volume Capté (M.m³)"
plot "vol_src.dat" using 2:xtic(1) title "Captation" with histograms every ::1::50

# Bloc 4 : Histogramme des 10 plus grandes usines (Volume capté)
set output "vol_src_large.png"
set title "10 Plus Grandes Usines - Volume Capté"
plot "vol_src.dat" using 2:xtic(1) title "Captation" with histograms every ::1::10
...
plot "vol_traitement.dat" using 2:xtic(1) title "Traitement" with histograms every ::1::50
...
plot "vol_traitement.dat" using 2:xtic(1) title "Traitement" with histograms every ::1::10
EOF